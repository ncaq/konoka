...
`Skill`ツールで`pull-request-style`スキルを呼び出し、
スタイルガイドラインに従ってください。
...
`pull-request-style`スキルのガイドラインに従い、
タイトルと本文を生成してください。
...
```bash
mktemp -d "${XDG_RUNTIME_DIR:-/tmp}/coding-agent-work/pull-request/XXXXXX"
```
...
生成したタイトルと本文の扱いをユーザに確認してください。

質問文にはタイトルと本文の全文を含めてください。
